...
const filterViedos = function (videoList) {
...
fetchDataFromServer(
  ...
  function (movie) {
    ...
    document.title = `${title} - Sherlok-Home `;
    ...
    for (const { key, name } of filterViedos(videos)) {
    ...
    fetchDataFromServer(
      ...
      function (data) {
        addSuggestedMovie(data.results);
      }
    );
  }
);

const addSuggestedMovie = function (movieList) {
  const movieListElem = document.createElement("section");
  movieListElem.classList.add("movie-list");
  movieList.ariaLabel = "You May Also Liked";

  movieListElem.innerHTML = `
    <div class="title-wrapper">
    <h3 class="title-large">You May Also Liked</h3>
  </div>
