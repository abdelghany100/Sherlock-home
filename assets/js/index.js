...
/**
 * home page section (trinding movies , top rating)
 */
...
`;
  ...
  addHeroSlide();
  /**
   * fetch home page section (trinding movies , top rating)
   */
...
const addHeroSlide = function () {
  ...
  addEventOnElements(sliderControls, "click", sliderStrart);
};

const creatMovieList = function ({ results: movieList }, title) {
