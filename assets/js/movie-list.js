...
fetchDataFromServer(
  ...
  function ({ results: movieList, total_pages }) {
    ...
    document.title = `${genreName} Movies - Sherlock-Home`;
  ...
  <button class="btn load-more" load-more>Load More</button>
    ...
    for (const movie of movieList) {
      const moviCard = creatMovieCard(movie);

      moveListElem.querySelector(".grid-list").appendChild(moviCard);
    }
    pageContent.appendChild(moveListElem);
    // creatMovieCard(movieList, pageContent);
